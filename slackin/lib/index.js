  ...
  app.get('/', (req, res) => {
    ...
    let page = dom('html',
      dom('head',
        ...
        dom('link rel="shortcut icon" href=/favicon.ico'),
        dom('link rel="stylesheet" href=/css/normalize.css'),
        dom('link rel="stylesheet" href=https://use.typekit.net/dcs3bcy.css'),
